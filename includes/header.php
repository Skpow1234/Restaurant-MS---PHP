<?php 
    ...
    define("APPURL", "http://localhost/RestaurantMs");
    define("APPIMAGES", "http://localhost/RestaurantMs/admin-panel/foods-admins/foods-images");
...
<head>
    <meta charset="utf-8">
    <title>RestaurantMs - Bootstrap Restaurant Template</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="<?php echo APPURL; ?>" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>RestaurantMs</h1>
